...
export default function GalleryPageClient({
  ...
  // on pourrait enlever le cover de la grille, mais tu gardes ton comportement actuel
  ...
  return (
    <div className="min-h-screen bg-[#faf7f2] dark:bg-slate-950 flex flex-col">
      ...
      <main id="main-content" className="flex-1">
        ...
        {/* ------------------------------------------------------------------ */}
        <section className="relative border-b border-slate-200 bg-slate-900 text-white dark:border-slate-800">
          {coverUrl && (
