...
export default function ContactPageClient({ dictionary }: Props) {
  ...
  // const email = "mohamadi.zongo115@gmail.com"
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const subject = form.subject.trim() || "Message depuis le site"
        ...
        <header className="mb-10 text-center md:text-left">
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-600 dark:text-slate-300">
            {t("contact.description") ||
              "Contactez le club Judo Aïkido Mazamet par téléphone, email ou sur place."}
          </p>
        </header>
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {t("contact.form.notice") ||
                  "En cliquant sur envoyer, votre messagerie s’ouvrira avec le message prérempli."}
              </p>
